...
// If both of them are in global namespace compiler gets ambigous call in case of using MyVector class.
template <typename T>
...
public:
    ...
    // In this case changing doesn't change output of a program, but in some cases it might be misleading.
...
private:
    ...
    // Name could be more precise ex. m_ref_cnt, as as it is intended to show current m_names reference count.
    size_t *m_ref_ptr;
};
